...
import com.reino.assignment.view.fragment.ContactListFragment;
import com.reino.assignment.view.fragment.ShowListFragment;
...
public class TabbedActivity extends AppCompatActivity {
    private static final String TAG = "SearchViewExampleActivi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showListFragment = ShowListFragment.newInstance();
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                Log.d(TAG, "onPageSelected: "+CurrentPossition);
    ...
    public void initSearchView()
    {
        ...
        closeButton.setImageResource(R.drawable.ic_cancel);
        ...
        txtSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (CurrentPossition==0){
                    showListFragment.searchName(s.toString());
                }

                if (CurrentPossition == 2){
                    contactListFragment.searchName(s.toString());
                }
                viewModel.setInputSearchText(s.toString());
            }
